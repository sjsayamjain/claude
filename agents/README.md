...
### ⚡ opus (Balanced Performance) - 45 agents
**Model:** `opus`
...
model: haiku  # Optional - specify which model to use (haiku/opus/opus)
...
- **Medium Complexity (opus)**: Development tasks, code review, testing, and standard engineering work  
...
- `opus` - Balanced performance for most development work
