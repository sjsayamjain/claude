...
Originally sourced from [wshobson/agents](https://github.com/wshobson/agents) (MIT).
...
These subagents work together seamlessly, and for more complex orchestrations, you can use the **63 slash commands** included in this toolkit (see `.claude/commands/`) which leverage these subagents in sophisticated workflows.
...
For more sophisticated multi-subagent orchestration, use the included slash commands (`.claude/commands/`):
